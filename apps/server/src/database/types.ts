...
export type DirectiveInterpretationsSelectType = InferSelectModel<
  typeof directiveInterpretations
>;
export type DirectiveInterpretationsInsertType = InferInsertModel<
  typeof directiveInterpretations
>;
...
export type OptimizationResultsSelectType = InferSelectModel<
  typeof optimizationResults
>;
export type OptimizationResultsInsertType = InferInsertModel<
  typeof optimizationResults
>;
